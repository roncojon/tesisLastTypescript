...
import EnhancedTable from 'components/ExamUserManagement'
import SelectTest from 'components/CreateExam/components/SelectTest'
...
console.log( data)
  ...
  async function httpResp(){
      const temp = await PostGeneric(postNeeds.key1, postNeeds.value1, postNeeds.key2, postNeeds.value2, endpoint.examen, postData)
      if(temp!==null)
 ...
 const patternSelectedHandler = (isPatronOriginal)=>{
  postNeeds ?
  setPostNeeds(prevState=>{return {...prevState,value2:isPatronOriginal}})
  :
  setPostNeeds({...postNeedsTemp,value2:isPatronOriginal})
 }
console.log(postNeeds)
  return (
...
// function useGetAllProtected(): { data: any; loading: any } {
